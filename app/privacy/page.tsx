...
export const metadata: Metadata = {
  title: "Privacy Policy | Valment Partners Inc.",
  description: "Learn how Valment Partners Inc. collects, uses, and protects your personal information. Our commitment to privacy and compliance with Canadian privacy legislation.",
};
              ...
              <CardContent className="p-8 md:p-12">
                ...
                <div className="mb-12">
                  ...
                  <p className="text-gray-700 leading-relaxed font-medium">
                    {content.introduction.commitment}
                  </p>
                </div>
